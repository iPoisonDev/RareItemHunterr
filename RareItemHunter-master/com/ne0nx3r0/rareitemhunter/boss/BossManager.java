...
import com.ne0nx3r0.rareitemhunter.boss.skill.SonicBoom;
import com.ne0nx3r0.rareitemhunter.boss.skill.SummonAllay;
import com.ne0nx3r0.rareitemhunter.boss.skill.Swallow;
...
public class BossManager
{
    ...
    public BossManager(RareItemHunter plugin)
    {
        ...
        availableBossSkills.add(new SonicBoom());
        availableBossSkills.add(new SummonAllay());
        availableBossSkills.add(new Swallow());
